...
async function getAuthUrl($ctx) {
    $ctx.ok({ status: 0, data: { key: 0, msg: 'https://openauth.alipay.com/oauth2/publicAppAuthorize.htm?app_id=2019080366013902&scope=auth_base&redirect_uri=http%3A%2F%2F39.100.232.50%2Fv1%2Faliapi%2Fredirect&pid=' + $ctx.query.id } })
}
